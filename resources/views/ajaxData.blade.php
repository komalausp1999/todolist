...
@foreach($todos as $todo)
    <li id="{{$todo->id}}">
        ...
        <a href="#" onclick="task_done('{{$todo->id}}')" class="icon-done"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
